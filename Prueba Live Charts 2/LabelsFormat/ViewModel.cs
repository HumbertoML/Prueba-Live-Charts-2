...
namespace Prueba_Live_Charts_2.LabelsFormat
{
    public class ViewModel
    {
        public ViewModel()
        {
            Series = new ObservableCollection<ISeries>
            {
                ...
                {
                    Values = new ObservableCollection<double> { 200, 558, 458, 249, 457, 339, 2000 },
                }
            };
            ...
            XAxes = new List<Axis>
            {
                new Axis
                {
                    Name = "hola mundo", // sample strings => "こんにちは" "你好" "أهلا"
